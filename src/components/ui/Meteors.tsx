      ...
      {meteors.map((_, idx) => (
        <span
          ...
          className={cn(
            ...
            "before:content-[''] before:absolute before:top-1/2 before:transform before:-translate-y-[50%] before:w-[50px] before:h-[1px] before:bg-gradient-to-r before:from-[#8b5cf6] before:to-transparent",
            className
          )}
          style={{
            top: 0,
